...
/* Window handling */
GLFWAPI int  GLFWAPIENTRY glfwOpenSubWindow( int width, int height, int redbits, int greenbits, int bluebits, int alphabits, int depthbits, int stencilbits, int mode, unsigned int parenthwnd);
